...
def main():
    ...
    topic_of_interest = input("Enter the research topic: ")
    number_of_subtopics = int(input("How many subtopics: "))
    research_depth = int(input("Enter research depth: "))

    identified_subtopics = generate_subtopics_list(
        topic_of_interest=topic_of_interest, number_of_subtopics=number_of_subtopics
    )
    print(f"Subtopics identified: {identified_subtopics}")

    subtopic_analyses = []
    for subtopic in identified_subtopics:
    ...
    create_markdown_file(topic=topic_of_interest, content=overall_detailed_report)
